...
//  console.log(id);
 const{getActorBiography,biography,actorMovies,details,similar,movieDetails,provider,credit,actor,getVideo,video,cast}=   useContext(myApiContext)
  ...
  <div className="container pt-6">
    ...
    <h3 className='text-white'>{actor.name}</h3>
        <div className="col-12 d-flex justify-content-center align-items-center flex-column">
            <img className='w-50' height={300} src={`https://image.tmdb.org/t/p/original/${actorpath}`} alt="" />
