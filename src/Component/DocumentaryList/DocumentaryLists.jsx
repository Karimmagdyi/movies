...
export default function DocumentaryLists() {
...
useEffect(()=>{
    docs()
        ...
        function docs(){
            axios.get(`https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=2&sort_by=popularity.desc&with_genres=99`,{
                method: 'GET',
        headers: {
