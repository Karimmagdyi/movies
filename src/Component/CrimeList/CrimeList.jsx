...
console.log('id',id);
  ...
  function showDetails(id){
    ...
    function crimeMovies(){
      axios.get(`https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc&with_genres=80`,{
        headers: {
      ...
      .then((res)=>{
console.log('crime',res.data.results);
setCrime(res.data.results)
      })
      .catch((err)=>{
        console.log('crime err',err);
      })
    }
  return <>
  ...
  <div className=' bg-black mx-auto contentt'>
      <div className='d-flex align-items-center flex-column'>
        <iframe height={400} className='w-100' src={`https://www.youtube-nocookie.com/embed/${video?.key }`} frameborder="0"></iframe>
...
<div className="row justify-content-center mt-5 gy-4">
  ...
  <div className="container pt-6">
    <div className="row gy-3 ">
        <h5 className='text-white h4'>Crime</h5>
        {crime.map((movies,index)=> <div  key={index} className= "col-6 col-md-3">
  ...
  <ul className="pagination d-flex justify-content-center pt-5 pb-4 ">
    ...
    <li className="page-item"><NavLink className="page-link" to={'/crime'}>1</NavLink></li>
    <li className="page-item" aria-current="page">
      <NavLink className="page-link" to={'/crime2'}>2</NavLink>
    </li>
    <li className="page-item"><NavLink className="page-link" to={'/crime3'}>3</NavLink></li>
