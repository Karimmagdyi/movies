...
export default function ComedyLists() {
useEffect(()=>{
    comedyMovies()
},[])
...
function showDetails(id){
    ...
    getVideo(id)
        ...
        function comedyMovies(){
            axios.get(`https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=2&sort_by=popularity.desc&with_genres=35`,{
                headers: {
...
<div className="row justify-content-center mt-5 gy-4">
  ...
  <div className="container pt-6">
    <div className="row gy-3 ">
        <h5 className='text-white h4'>Comedy</h5>
        {comedy.map((movies,index)=> <div  key={index} className= 'col-6 col-md-3 '>
  ...
  <ul className="pagination d-flex justify-content-center pt-5 pb-4 ">
    ...
    <li className="page-item"><NavLink className="page-link" to={'/comedy'}>1</NavLink></li>
    <li className="page-item" aria-current="page">
      <NavLink className="page-link" to={'/comedy2'}>2</NavLink>
    </li>
    <li className="page-item"><NavLink className="page-link" to={'/comedy3'}>3</NavLink></li>
