...
export default function Comedyy() {
useEffect(()=>{
    comedyMovies()
},[])
...
function showDetails(id){
    ...
    getCast(id)
        ...
        function comedyMovies(){
            axios.get(`https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=3&sort_by=popularity.desc&with_genres=35`,{
                headers: {
